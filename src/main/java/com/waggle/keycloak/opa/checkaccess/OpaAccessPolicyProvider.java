package com.waggle.keycloak.opa.checkaccess;

import com.waggle.keycloak.accessmgmt.AccessDecision;
import com.waggle.keycloak.accessmgmt.AccessDecisionContext;
import com.waggle.keycloak.accessmgmt.AccessPolicyProvider;
...
import com.waggle.keycloak.opa.client.OpaRequest;
...
import com.waggle.keycloak.opa.config.CompositeConfig;
import com.waggle.keycloak.opa.config.ConfigWrapper;
import com.waggle.keycloak.opa.config.MapConfig;
...
public class OpaAccessPolicyProvider implements AccessPolicyProvider {
    ...
    protected OpaResource createResource(RealmModel realm, ClientModel client, ConfigWrapper config, RealmResource resource) {
        ...
        opaResourceBuilder.RealmResourceType(resource.getType());
        opaResourceBuilder.RealmResourceId(resource.getId());
        opaResourceBuilder.RealmResourceName(resource.getName());
        opaResourceBuilder.RealmResourcePath(resource.getPath());
        opaResourceBuilder.RealmResourceScopes(resource.getScopes());
